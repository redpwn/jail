...
type NsJailConfig struct {
	...
	MaxConns *uint32 `protobuf:"varint,85,opt,name=max_conns,json=maxConns,def=0" json:"max_conns,omitempty"`
	...
	RlimitAs         *uint64 `protobuf:"varint,28,opt,name=rlimit_as,json=rlimitAs,def=4096" json:"rlimit_as,omitempty"` // In MiB
	...
	RlimitStack     *uint64 `protobuf:"varint,40,opt,name=rlimit_stack,json=rlimitStack,def=8" json:"rlimit_stack,omitempty"`
	...
	RlimitMemlock      *uint64 `protobuf:"varint,88,opt,name=rlimit_memlock,json=rlimitMemlock,def=64" json:"rlimit_memlock,omitempty"`
	RlimitMemlockType  *RLimit `protobuf:"varint,89,opt,name=rlimit_memlock_type,json=rlimitMemlockType,enum=nsjail.RLimit,def=1" json:"rlimit_memlock_type,omitempty"`
	RlimitRtprio       *uint64 `protobuf:"varint,90,opt,name=rlimit_rtprio,json=rlimitRtprio,def=0" json:"rlimit_rtprio,omitempty"`
	RlimitRtprioType   *RLimit `protobuf:"varint,91,opt,name=rlimit_rtprio_type,json=rlimitRtprioType,enum=nsjail.RLimit,def=1" json:"rlimit_rtprio_type,omitempty"`
	RlimitMsgqueue     *uint64 `protobuf:"varint,92,opt,name=rlimit_msgqueue,json=rlimitMsgqueue,def=1024" json:"rlimit_msgqueue,omitempty"` // In bytes
	RlimitMsgqueueType *RLimit `protobuf:"varint,93,opt,name=rlimit_msgqueue_type,json=rlimitMsgqueueType,enum=nsjail.RLimit,def=1" json:"rlimit_msgqueue_type,omitempty"`
	// Disable all rlimits, default to limits set by parent
	DisableRl *bool `protobuf:"varint,84,opt,name=disable_rl,json=disableRl,def=0" json:"disable_rl,omitempty"`
	...
	CloneNewtime *bool `protobuf:"varint,86,opt,name=clone_newtime,json=cloneNewtime,def=0" json:"clone_newtime,omitempty"`
	...
	CgroupMemMax *uint64 `protobuf:"varint,61,opt,name=cgroup_mem_max,json=cgroupMemMax,def=0" json:"cgroup_mem_max,omitempty"` // In bytes
	...
	Cgroupv2Mount *string `protobuf:"bytes,73,opt,name=cgroupv2_mount,json=cgroupv2Mount,def=/sys/fs/cgroup" json:"cgroupv2_mount,omitempty"`
	// Use cgroup v2
	UseCgroupv2 *bool `protobuf:"varint,74,opt,name=use_cgroupv2,json=useCgroupv2,def=0" json:"use_cgroupv2,omitempty"`
	// Should the 'lo' interface be brought up (active) inside this jail?
	IfaceNoLo *bool `protobuf:"varint,75,opt,name=iface_no_lo,json=ifaceNoLo,def=0" json:"iface_no_lo,omitempty"`
	// Put this interface inside the jail
	IfaceOwn []string `protobuf:"bytes,76,rep,name=iface_own,json=ifaceOwn" json:"iface_own,omitempty"`
	// Parameters for the cloned MACVLAN interface inside jail
	MacvlanIface *string `protobuf:"bytes,77,opt,name=macvlan_iface,json=macvlanIface" json:"macvlan_iface,omitempty"` // Interface to be cloned, eg 'eth0'
	MacvlanVsIp  *string `protobuf:"bytes,78,opt,name=macvlan_vs_ip,json=macvlanVsIp,def=192.168.0.2" json:"macvlan_vs_ip,omitempty"`
	MacvlanVsNm  *string `protobuf:"bytes,79,opt,name=macvlan_vs_nm,json=macvlanVsNm,def=255.255.255.0" json:"macvlan_vs_nm,omitempty"`
	MacvlanVsGw  *string `protobuf:"bytes,80,opt,name=macvlan_vs_gw,json=macvlanVsGw,def=192.168.0.1" json:"macvlan_vs_gw,omitempty"`
	MacvlanVsMa  *string `protobuf:"bytes,81,opt,name=macvlan_vs_ma,json=macvlanVsMa,def=" json:"macvlan_vs_ma,omitempty"`
	MacvlanVsMo  *string `protobuf:"bytes,87,opt,name=macvlan_vs_mo,json=macvlanVsMo,def=private" json:"macvlan_vs_mo,omitempty"`
	// Niceness level of the jailed process
	NiceLevel *int32 `protobuf:"varint,82,opt,name=nice_level,json=niceLevel,def=19" json:"nice_level,omitempty"`
	// Binary path (with arguments) to be executed. If not specified here, it
	//can be specified with cmd-line as "-- /path/to/command arg1 arg2"
	ExecBin *Exe `protobuf:"bytes,83,opt,name=exec_bin,json=execBin" json:"exec_bin,omitempty"`
}
...
var file_config_proto_rawDesc = []byte{
	...
	0x65, 0x63, 0x46, 0x64, 0x22, 0xb6, 0x1f, 0x0a, 0x0c, 0x4e, 0x73, 0x4a, 0x61, 0x69, 0x6c, 0x43,
	...
	,
	...
	0x12, 0x09, 0x0a, 0x05, 0x45, 0x52, 0x52, 0x4f, 0x52, 0x10, 0x03, 0x12, 0x09, 0x0a, 0x05, 0x46,
	0x41, 0x54, 0x41, 0x4c, 0x10, 0x04, 0x2a, 0x30, 0x0a, 0x06, 0x52, 0x4c, 0x69, 0x6d, 0x69, 0x74,
	0x12, 0x09, 0x0a, 0x05, 0x56, 0x41, 0x4c, 0x55, 0x45, 0x10, 0x00, 0x12, 0x08, 0x0a, 0x04, 0x53,
	0x4f, 0x46, 0x54, 0x10, 0x01, 0x12, 0x08, 0x0a, 0x04, 0x48, 0x41, 0x52, 0x44, 0x10, 0x02, 0x12,
	0x07, 0x0a, 0x03, 0x49, 0x4e, 0x46, 0x10, 0x03,
}
